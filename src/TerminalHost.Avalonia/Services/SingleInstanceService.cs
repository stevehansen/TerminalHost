...
#pragma warning restore CS0067
    ...
    {
        // Check if another instance has the mutex by trying to acquire it
        try
        {
            using var testMutex = new Mutex(false, MutexName, out bool createdNew);
            return !createdNew;
        }
        catch (PlatformNotSupportedException)
        {
            ...
            try
            {
                ...
                return false; // We got the lock, so main instance is not running
            }
