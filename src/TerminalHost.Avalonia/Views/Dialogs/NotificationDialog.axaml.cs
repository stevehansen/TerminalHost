...
public partial class NotificationDialog : Window
{
    ...
    protected override void OnKeyDown(KeyEventArgs e)
    {
        ...
        if (e.Key == Key.Escape)
        {
            ...
            Result = CancelButton.IsVisible ? Services.DialogResult.Cancel :
                     NoButton.IsVisible ? Services.DialogResult.No :
        ...
        else if (e.Key == Key.Enter)
        {
            ...
            Result = OKButton.IsVisible ? Services.DialogResult.OK :
                     YesButton.IsVisible ? Services.DialogResult.Yes :
