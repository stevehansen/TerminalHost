...
/// </summary>
public sealed class LinkDetectionService(IProfileRegistry profileRegistry, IFileSystem fileSystem, IProcessService processService, IDialogService dialogService) : ILinkDetectionService
{
