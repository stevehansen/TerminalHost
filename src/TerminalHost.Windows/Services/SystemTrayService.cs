...
public sealed class SystemTrayService : TerminalHost.Windows.Interfaces.ISystemTrayService
{
    ...
    public void Initialize(Window mainWindow)
    {
        ...
        else
        {
            ...
            try
            {
                var resourceStream = System.Windows.Application.GetResourceStream(new Uri("pack://application:,,,/Resources/app.ico"));
