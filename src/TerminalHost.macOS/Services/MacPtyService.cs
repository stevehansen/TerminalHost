...
/// </summary>
public class MacPtyService : PosixPtyServiceBase<PtySession<MacOSPtySyscalls>, MacOSPtySyscalls>
{
    protected override PtySession<MacOSPtySyscalls> CreateSession(PtyStartArgs args)
