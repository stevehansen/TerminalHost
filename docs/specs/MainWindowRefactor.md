...
- **(Done)** Extracted Help popup into `Views/Popups/HelpView.xaml` and `ViewModels/MainViewModel.cs` (for logic).
- **(Done)** Extracted Command Palette popup into `Views/Popups/CommandPaletteView.xaml` and `ViewModels/MainViewModel.cs` (for logic).
